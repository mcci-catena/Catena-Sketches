# Understanding Catena 4450 format 0x16

Catena 4450 format 0x16 messages are always sent on LoRaWAN port 1, and have the following layout.
...
5 | 2 | uint16 | Water Pressure
6 | n/a | n/a | reserved, must always be zero.
...
// sent by the MCCI Catena 4410/4450/4551 soil/water, power and Water Pressure/Level applications.
...
// Calculate the Water Level from the obtained Water Pressure.
// from https://www.engineeringtoolbox.com/hydrostatic-pressure-water-d_1632.html
...
//	Hydrostatic pressure in a water column (density 1000 kg/m3)
...
function Decoder(bytes, port) {
    ...
    if (port === 1) {
        ...
        if (cmd == 0x14) {
            ...
            // test vectors:
            //  16 01 18 00 ==> vBat = 1.5
            //  16 01 F8 00 ==> vBat = -0.5
            //  16 05 F8 00 42 ==> boot: 66, vBat: -0.5
