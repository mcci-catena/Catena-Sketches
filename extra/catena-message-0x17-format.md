...
- [Bitmap fields and associated fields](#bitmap-fields-and-associated-fields)
	...
	- [Gas resistance (field 6)](#gas-resistance-field-6)
	- [Quality flags (field 7)](#quality-flags-field-7)
...
6 | 2 | [uflt16](#uflt16) | [Gas resistance](#gas-resistance-field-6)
7 | 1 | [uint8](#uint8) | [Quality flags](#quality-flags-field-7)
...
Field 5, if present, represents the BSEC Index of Air Quality (IAQ).
...
### Gas resistance (field 6)

Field 6, if present, represents the base-10 logarithm of the gas resistance, divided by 16.  This is transmitted as a [`uflt16](#uflt16).

### Quality flags (field 7)
...
|Input | vBat | vBus | Boot | Temp (deg C) | P (mBar) | RH % | Lux |  AQI  | Gas R | Quality |
|:-----|-----:|-----:|-----:|-------------:|---------:|-----:|----:|------:|----:|----:|
|`17 01 18 00` | +1.5 | | |  |            |           |      |     |       |
|`17 01 F8 00` | -0.5 | | |  |            |           |      |     |       |
...
|`17 FD 3C 05 53 16 EE 61 F1 94 00 A7 DB 91 EB F7 03` | 3.751220703125 |  | 83 | 22.9296875 | 1002.92 | 57.8125 | 167 | 5.982421875 | 92.53125 | 3 |
