...
void setup_platform(void)
        ...
        gCatena.SafePrintf("\n");
        gCatena.SafePrintf("-------------------------------------------------------------------------------\n");
        gCatena.SafePrintf("This is the catena4617_simple program V%s.\n", sVersion);
                {
                char sRegion[16];
...
void fillBuffer(TxBuffer_t &b)
        ...
        if (fHs3001)
                ...
                bool fResult = gHs3001.getTemperatureHumidity(m);
